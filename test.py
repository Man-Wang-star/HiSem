...
def main(args):
    ...
    encoder_trans = AttentiveEncoder(n_layers=args.n_layers,
                                          ...
                                          attention_module_kwargs={'top_k': args.top_k, 'num_experts': args.num_experts,
                                                                   'n_shared_experts': args.n_shared_experts,
                                                                   'n_group': args.n_group,
                                                                   'topk_group': args.topk_group})
    decoder = DecoderTransformer(decoder_type=args.decoder_type,
    ...
    with torch.no_grad():
        ...
        for ind, batch_data in enumerate(
            ...
            feat, diff_feat, cls_logits = encoder_trans(feat1, feat2, supervised_label=None)  # [B,L,D]  [B,]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_length', type=int, default=41, help='path of the data lists')  #41，26
    ...
    # Test
    parser.add_argument('--gpu_id', type=int, default=1, help='gpu id in the training.')
