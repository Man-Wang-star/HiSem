...
parser.add_argument('--input_captions_json', type = str, default = 'D:\datasets\LEVIR_CC\Levir-CC-dataset\LevirCCcaptions.json', help = 'input captions json file')
parser.add_argument('--save_dir', type = str, default = 'D:\datasets\LEVIR_CC\\')
